...
$(function(){
		...
		$("#selectName").keydown(function(event) {
			...
			if(event.keyCode==13){
				$.ajax({
					url:"workbench/clue/selectName.do",
					data:{
			...
			$("#svaeBtn").click(function () {
				...
				if($ck.length==0){
					...
					$.ajax({
						...
						url:"workbench/clue/saveRelevance.do",
						data:parm,
						type:"post",
						dataType:"json",
						success:function(data){
		 ...
		 $.ajax({
				...
				success:function(data){
					...
					$.each(data,function(i,n){
						...
						html +='<td>'+n.endDate+'</td>',
						html +='<td>'+n.owner+'</td>',
						html +='<td><a href="javascript:void(0);" onclick="removeBtn(\''+n.id+'\')"  style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>',
						html +='</tr>'
					})
	...
	function removeBtn(id) {
		...
		$.ajax({
			...
			url:"workbench/clue/removeBtn.do",
			data:{
				"id":id
			},
			type:"post",
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="selectName" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
				...
				<div class="modal-footer">
					...
					<button type="button" id="svaeBtn" class="btn btn-primary" data-dismiss="modal">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?id=${c.id}&owner=${c.createBy}&fullname=${c.fullname}&appellation=${c.appellation}&company=${c.company}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${c.createBy }</b></div>
